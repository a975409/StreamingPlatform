...
namespace StreamingPlatform.Domain
{
    public class MemberService
    {
        ...
        public MemberService(StreamingPlatformContext context)
        {
            _context = context;
        }
        ...
        public void Login(MemberLoginDto dto)
        {
           if(string.IsNullOrEmpty(dto.AccountNo))
            ...
            var member = _context.Member.AsNoTracking().FirstOrDefault(m => m.AccountNo == dto.AccountNo && m.Pwd == dto.Pwd);
        ...
        public void Register(RegisterMemberDto dto)
        {
            ...
            bool accountNoIsexist = _context.Member.AsNoTracking().Any(m => m.AccountNo == dto.AccountNo);
            ...
            bool emailexist = _context.Member.AsNoTracking().Any(m => m.Email == dto.Email);
